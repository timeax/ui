import type { SidebarController } from './sidebar-manager.types';

type AnyCtrl = SidebarController<any, any>;
...
const GLOBAL_KEY = '__sidebar_store__';
...
export function getSidebarStore(): SidebarStore {
    ...
    return g[GLOBAL_KEY] as SidebarStore;
}
