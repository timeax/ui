    ...
    return (
        <div className="p-8 space-y-12 max-w-5xl mx-auto">
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-bold border-b pb-2">Tones & Emphases</h2>
                <div className="grid gap-4">
                    {(['primary', 'success', 'info', 'warning', 'danger', 'secondary', 'neutral', 'theme', 'white', 'grey'] as const).map((tone) => (
                        <div key={tone} className="flex flex-wrap items-center gap-3 p-3 rounded-lg border bg-zinc-50/50 dark:bg-zinc-900/30">
            ...
            {/* Sizes & Icons */}
            <section className="space-y-4">
                <h2 className="text-xl font-bold border-b pb-2">Sizes & Icon Placement</h2>
                <div className="flex flex-wrap items-end gap-4">
                    <Button size="sm" icon={<Mail />}>Small</Button>
                    <Button size="md" icon={<Mail />}>Medium</Button>
                    <Button size="lg" icon={<Mail />}>Large</Button>
                    <Button size="xl" icon={<Mail />}>Extra Large</Button>
                    <Button size="2xl" icon={<Mail />}>2XL</Button>
                    <Button size="3xl" icon={<Mail />}>3XL</Button>
                </div>
                <div className="flex flex-wrap items-center gap-4 mt-4">
                    <Button icon={<ArrowRight />} iconPosition="right">Next Page</Button>
                    <Button icon={<Plus />} iconGap={12}>Custom Gap</Button>
                    <Button icon={<Star />} iconSize="3xl" tone="warning">Custom Icon Size</Button>
                </div>
            </section>

            {/* Icon Only Buttons */}
            <section className="space-y-4">
                <h2 className="text-xl font-bold border-b pb-2">Icon-Only Buttons</h2>
                <div className="flex flex-wrap items-center gap-4">
                    <Button size="icon-sm" icon={<Star />} tone="warning" />
                    <Button size="icon-md" icon={<Star />} tone="warning" />
                    <Button size="icon-lg" icon={<Star />} tone="warning" />
                    <Button size="icon-xl" icon={<Star />} tone="warning" />
                    <Button size="icon-2xl" icon={<Star />} tone="warning" />
                    <Button size="icon-3xl" icon={<Star />} tone="warning" />
                </div>
            </section>

            {/* States: Loading & Disabled */}
            <section className="space-y-4">
                <h2 className="text-xl font-bold border-b pb-2">States (Loading & Disabled)</h2>
                <div className="flex flex-wrap gap-4">
                    <Button loading>Solid Loading</Button>
                    <Button tone="success" emphasis="soft" loading icon={<Mail />}>Soft Loading</Button>
                    <Button tone="danger" emphasis="outline" loading>Outline Loading</Button>
                    <Button disabled icon={<Mail />}>Disabled Button</Button>
            ...
            {/* Shapes / Rounding */}
            <section className="space-y-4">
                <h2 className="text-xl font-bold border-b pb-2">Rounding (MD, Pill, None)</h2>
                <div className="flex flex-wrap gap-4">
            ...
            {/* Polymorphism */}
            <section className="space-y-4">
                <h2 className="text-xl font-bold border-b pb-2">Polymorphism (Render as Anchor Link)</h2>
                <div className="flex flex-wrap gap-4">
